function [res] = runsvm(Ks,lk,r)
% Copyright 2012 Nino Shervashidze, Karsten Borgwardt
% runsvm(Ks,lk)
% Ks = 1 x h cell array of kernelmatrices (n*n)
% r is a randomly generated n*1 permutation vector
...
addpath('software/libsvm-3.22/matlab');
