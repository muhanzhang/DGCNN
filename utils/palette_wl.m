function [equivalence_classes, counter, newA, newl] = palette_wl(A, labels)
%  Usage: palette_wl for enclosing subgraph labeling in WLNM
%  --Input--
...
%%
  ...
  [~, I] = sort(equivalence_classes, 'descend');
  newA = A(I, I);
  newl = original_labels(I);
